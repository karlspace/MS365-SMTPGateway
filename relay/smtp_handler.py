...
def build_controller_kwargs() -> dict[str, Any]:
    ...
    host = os.environ.get("SMTP_LISTEN_HOST", '::')  # nosec B104
    # aiosmtpd's readiness probe (_trigger_server) opens a CLIENT connection to
    # the bind host once the server is up. '::'/"::" are valid *bind*
    ...
    if host in ('::', "::", "*"):  # nosec B104 - intentional all-interfaces bind
        host = ""
